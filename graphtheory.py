...
class GraphTraversal:
    def __init__(self, root):
        self.window = root
        self.make_canvas = Canvas(self.window,bg="white",relief=RAISED,bd=7,width=500,height=500)
    ...
    def basic_set_up(self):
        heading = Label(self.make_canvas,text="Graph Traversing Visualization",bg="white",fg="black",font=("Arial",20,"bold","italic"))
        heading.place(x=50,y=10)

        bfs_btn = Button(self.window,text="BFS",font=("Arial",15,"bold"),bg="black",fg="white",relief=RAISED,bd=8,command=self.bfs_traversing)
        bfs_btn.place(x=20,y=530)

        dfs_btn = Button(self.window, text="DFS", font=("Arial", 15, "bold"), bg="black", fg="white", relief=RAISED, bd=8, command=self.dfs_traversing)
        dfs_btn.place(x=400, y=530)

        self.status = Label(self.make_canvas,text="Not Visited",bg="white",fg="black",font=("Arial",20,"bold","italic"))
